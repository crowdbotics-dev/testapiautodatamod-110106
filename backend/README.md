...
## Project Structure
    ...
    ├── testapiautodatamod_110106  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_110106`
...
2. Clone this repo and `cd testapiautodatamod_110106`
